...
class XplainColors{
  ...
  Color circleBackground(double opacity){
    return _prefs.theme ? colors.menuItemDark : colors.butterflyBush.withOpacity(opacity);
  }
  Color shadowColor(double opacity){
    return _prefs.theme ? colors.shadowsDark.withOpacity(opacity) : colors.shadowsLight.withOpacity(opacity);
  }
  ...
  Color textColorOpacity(double opacity){
    return _prefs.theme ? Colors.white.withOpacity(opacity): colors.text.withOpacity(opacity);
  }
  Color whiteTextColor(double opacity){
    return _prefs.theme ? Colors.white.withOpacity(1) : Colors.white.withOpacity(1);
  }
  Color blackTextColor(double opacity){
    return _prefs.theme ? Colors.white.withOpacity(opacity) : Colors.black.withOpacity(opacity);
  }
  Color chickenLittleColor(){
    return _prefs.theme ? null : colors.chickenLittle;
  }
  Color blueTextColor(double opacity){
    return _prefs.theme ? Colors.white : colors.mentoriatitleTxt.withOpacity(opacity);
  }
